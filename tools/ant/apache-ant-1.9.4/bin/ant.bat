...
IF "%PROCESSOR_ARCHITECTURE%"=="x86" (set libPath=x86) else (set libPath=x64)

set ANT_OPTS=-Xms1024m -Xmx1024m -Djava.library.path=..\..\..\tools\jtds-1.3.1-dist\%libPath%\SSO\;..\..\..\tools\sqljdbc_4.0\enu\auth\%libPath%\


rem set ANT_OPTS=-Xms1024m -Xmx1024m
echo setando library path no ant.bat %ANT_OPTS% 
cd
